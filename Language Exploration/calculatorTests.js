...
describe("An addition function", function() {
    ...
    it("minus two individual numbers", function() {
        //Input (inputs and expected output)
        let number1 = 100, number2 =20, expectedResult = 80;

        //Get the actual output
        let actualResult = subtract(number1, number2);
    ...
    it("add two arrays of numbers", function() {
        //Input (inputs and expected output)
        let array1 = [10], array2 = [20], expectedResult = 30;

        //Get the actual output
        let actualResult = addTwoArrays(array1, array2);
    ...
    it("add two functions that return numbers", function() {
        //Input (inputs and expected output)
        let integer1 = () => 10, integer2 = () => 20, expectedResult = 30;

        //Get the actual output
        let actualResult = addNumbersFromTwoFunctions(integer1, integer2);
